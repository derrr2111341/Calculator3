...
const equalButton = document.getElementById('btnequals');
const clearButton = document.getElementById('btnclear');
const deleteButton = document.getElementById('btndelete');
const dotButton = document.getElementById('btndot');

const sqrtButton = document.getElementById('btnsqrt');
const clearEntryButton = document.getElementById('btnclear-entry');
